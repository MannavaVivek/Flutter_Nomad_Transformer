...
void uploadItemsToFirestore() async {
  ...
  '36': BlogPost(
    postId: '36',
    title: 'Mallorca: A Mediterranean Paradise',
    summary: 'Experience the enchanting island of Mallorca ...',
    caption: 'Mallorca, where sun-kissed shores meet a vibrant culture.',
    imageUrl: 'assets/images/mallorca_unsplash.jpg',
    imageAttribution: 'Photo by Eugene Zhyvchik on Unsplash',
    content: 'Mallorca, the largest island in the Balearic Islands archipelago in Spain, is famed for its diverse landscapes, from stunning sandy beaches and azure seas to the serene Tramuntana mountains. Known for its captivating old town of Palma, picturesque villages, and historic sites like the Royal Palace of La Almudaina, Mallorca offers an intriguing mix of relaxation and cultural exploration.',
    country: 'Spain',
    city: 'Mallorca',
  ),
  '37': BlogPost(
    postId: '37',
    title: 'Barcelona: A Tapestry of Art and Culture',
    summary: 'Unravel Barcelona, a city where architectural wonders intertwine ...',
    caption: 'Barcelona, where tradition and innovation coexist ...',
    imageUrl: 'assets/images/barcelona_unsplash.jpg',
    imageAttribution: 'Photo by Logan Armstrong on Unsplash',
    content: "Barcelona, the cosmopolitan capital of Spain’s Catalonia region, is renowned for its art, architecture, and a distinctive culture that sets it apart. With landmarks such as the Sagrada Familia, Park Güell, and an array of structures by the famous architect Antoni Gaudí, Barcelona is a city that beautifully showcases the amalgamation of the old and the new.",
    country: 'Spain',
    city: 'Barcelona',
  ),
  '38': BlogPost(
